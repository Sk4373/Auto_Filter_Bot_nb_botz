...
ᴀғᴛᴇʀ ᴛʜᴀᴛ, ᴛʀʏ ᴀᴄᴄᴇssɪɴɢ ᴛʜᴀᴛ ᴍᴏᴠɪᴇ ᴛʜᴇɴ, ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ "ᴛʀʏ ᴀɢᴀɪɴ" ʙᴜᴛᴛᴏɴ.
    ...
    FORCESUBS_TEXT="""<b><blockquote>❗𝖸𝗈𝗎 𝖠𝗋𝖾 𝖭𝗈𝗍 𝖯𝗋𝖾𝗌𝖾𝗇𝗍 𝖮𝗇 𝖮𝗎𝗋 𝖡𝖺𝖼𝗄𝗎𝗉 𝖢𝗁𝖺𝗇𝗇𝖾𝗅𝗌❗</blockquote>

𝖸𝗈𝗎 𝖧𝖺𝗏𝖾 𝖳𝗈 𝖩𝗈𝗂𝗇 𝖮𝗎𝗋 𝖡𝖺𝖼𝗄𝖴𝗉 𝖢𝗁𝖺𝗇𝗇𝖾𝗅𝗌 𝖳𝗈𝗈🥹
𝖥𝗂𝗋𝗌𝗍 𝖢𝗅𝗂𝖼𝗄 𝖮𝗇 "𝖩𝗈𝗂𝗇 𝖢𝗁𝖺𝗇𝗇𝖾𝗅" 𝖳𝗁𝖾𝗇 𝖳𝖺𝗉 𝖮𝗇 "𝖳𝗋𝗒 𝖠𝗀𝖺𝗂𝗇" 𝖡𝗎𝗍𝗍𝗈𝗇 ❤️‍🔥.

<blockquote>আমাদের এই মুভি বট থেকে কোনো ফাইল নিতে হলে আপনাকে প্রথমে আমাদের এই ব্যাকআপ চ্যানেল গুলাতে জয়েন হতে হবে. প্রথমে "Join Channel" এ ক্লিক করুন , চ্যানেল গুলো জয়েন করুন , এবং "Try Again" এ ক্লিক করুন 🌚</blockquote>

<blockquote>इस मूवी bot से फाइल लेने के लिए आपको हमारे सारे बैकअप चैनल्स को ज्वाइन करना होगा , पहले "Join Now" पे क्लिक करके चैनल ज्वाइन करे फिर "Try Again" पे क्लिक करे</blockquote>

<blockquote>ഈ മൂവി ബോട്ട് ഉപയോഗിച്ച് ഫയൽ നേടാൻ, ഞങ്ങളുടെ എല്ലാ ബാക്ക്‌അപ്പ് ചാനലുകളും നിങ്ങൾ ജോയിൻ ചെയ്യേണ്ടതുണ്ട്. ആദ്യം "Join Now" ക്ലിക്കുചെയ്ത് ചാനലുകൾ ജോയിൻ ചെയ്യുക, ശേഷം "Try Again" ക്ലിക്കുചെയ്യുക.</blockquote>
...
3:- ʜᴇʀᴇ ᴀʀᴇ ᴛʜᴇ ғᴜʟʟ ᴠɪᴅᴇᴏ <a href=https://t.me/how_to_dwnload/46>ᴛᴜᴛᴏʀɪᴀʟ</a> ʜᴏᴡ ᴛᴏ sᴇᴛᴜᴘ ᴛʜɪs ʙᴏᴛ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ғᴏʀ ᴇᴀʀɴɪɴɢ

4:- ᴄʀᴇᴀᴛᴇ ᴀᴄᴄᴏᴜɴᴛ ᴏɴ ᴀɴʏ sʜᴏʀᴛɴᴇʀ ʟɪᴋᴇ ʏᴏᴜ ᴄᴀɴ ᴀʟsᴏ ᴜsᴇ ᴛʜɪs ʙᴇsᴛ sʜᴏʀᴛɴᴇʀ <a href=https://tnshort.net/ref/Zafar12>ᴢɪᴘꜱʜᴏʀᴛ</a>.
...
🏷️ <a href='https://t.me/zsbhere'>ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ ᴘʀᴏᴏꜰ</a>
...
Mᴇꜱꜱᴀɢᴇ : <b>{}</b>"""
    ...
    CAPTION = """<b><a href="https://t.me/+i-Kz-jd6d8ZhMTk9">{file_name}</a></b>\n\n<b>⚜️ Powered By : <a https://t.me/CornersOfficial>[CornersOfficial]</a></b>"""
